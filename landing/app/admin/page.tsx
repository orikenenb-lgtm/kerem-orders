      ...
      <div style={{ background: tokens.surface, border: `1px solid ${tokens.border}`, borderRadius: 14, padding: "1.1rem 1.2rem", marginBottom: "1.25rem", display: "grid", gap: "0.7rem" }}>
        ...
        <div style={{ borderTop: `1px solid ${tokens.border}`, paddingTop: "0.8rem", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
          <div>
            ...
            <div style={{ fontFamily: tokens.assistant, fontSize: "0.85rem", color: tokens.body }}>מוצר או קטגוריה שנמחקו ברווחית ועדיין מופיעים? מסתירים כאן, וההסתרה גוברת על העדכון — הם לא יחזרו. שום דבר לא נמחק, אפשר להחזיר בלחיצה.</div>
          </div>
          <Link href="/admin/hidden" style={{ ...ghostBtn, textDecoration: "none", whiteSpace: "nowrap" }}>הסתרה מהאתר ←</Link>
        </div>
        <div style={{ borderTop: `1px solid ${tokens.border}`, paddingTop: "0.8rem", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
          <div>
            <div style={{ fontFamily: tokens.rubik, fontWeight: 800, fontSize: "1.1rem", color: tokens.text }}>לקוחות</div>
            <div style={{ fontFamily: tokens.assistant, fontSize: "0.85rem", color: tokens.body }}>כל מי שרשום במערכת — חיפוש לפי שם עסק, איש קשר, טלפון, אימייל או ח״פ, עם כתובת המשלוח וההזמנות של כל אחד.</div>
          </div>
          <Link href="/admin/customers" style={{ ...ghostBtn, textDecoration: "none", whiteSpace: "nowrap" }}>רשימת הלקוחות ←</Link>
        </div>
        <div style={{ borderTop: `1px solid ${tokens.border}`, paddingTop: "0.8rem", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
          <div>
        ...
        <div style={{ borderTop: `1px solid ${tokens.border}`, paddingTop: "0.8rem", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
          ...
          <Link href="/admin/collections" style={{ ...ghostBtn, textDecoration: "none", whiteSpace: "nowrap" }}>ניהול הקטלוגים ←</Link>
        </div>
        <div style={{ borderTop: `1px solid ${tokens.border}`, paddingTop: "0.8rem", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
          <div>
