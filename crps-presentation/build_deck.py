...
.card{{background:#fff;border:1px solid var(--line);border-radius:10px;padding:24px 20px;
  min-height:235px;display:flex;flex-direction:column;justify-content:center;
  box-shadow:-7px 7px 0 #e6dfcd, -8px 8px 0 -1px #d8d0bc, 0 22px 34px #1c24341c}}
...
.asks li{{counter-increment:ask;display:flex;align-items:center;gap:22px;
  background:#222f4c;border:1px solid #ffffff1f;border-radius:10px;padding:16px 24px;
  font-size:17.5px;line-height:1.55;font-weight:300;
  box-shadow:-7px 7px 0 #0b1322, -8px 8px 0 #070d18, 0 20px 34px #0007}}
