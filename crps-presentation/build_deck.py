...
<div class="split">
  <div class="txt">
    ...
    <p class="body">
      ...
      וערכות ״We Will Dance Again״ — שאני מעניקה באופן אישי
      <b>לשורדי מסיבת הנובה ולשורדים ששבו מהשבי</b>.
    </p>
    <p class="body accent-line">
...
# ================================================== 20-22 · GIVING WALLS
page(f"""
<div class="wall-head"><h2 class="h">זוג אחר זוג — לשורדי הנובה והשבי</h2>
<p class="sub">כל זוג מצויר ביד, כל מסירה היא חיבוק. אנשים שראו את החושך הכי גדול —
מקבלים תזכורת אישית שעם ישראל חי, ושהם לא לבד.</p></div>
...
<p class="sub">כל תמונה כאן היא מפגש עם שורד, שורדת או משפחה — ואישה אחת עם CRPS
שמגלה בכל פעם מחדש: נתינה היא התרופה החזקה שיש.</p></div>
