...
<div class="center-head">
  ...
  <h2 class="h">הכאב שמדורג מעל הכל</h2>
</div>
<div class="stats">
  <div class="stat main"><div class="num">42<span class="of">/50</span></div>
    <p>במדד הכאב של מקגיל (McGill) — מעל לידה ללא אלחוש, מעל קטיעת אצבע</p></div>
  <div class="statcol">
    <div class="stat"><div class="num s">3–4×</div><p>שכיח יותר בנשים — לרוב סביב העשור הרביעי–חמישי לחיים</p></div>
    <div class="stat"><div class="num s">5–26</div><p>מקרים חדשים ל‑100,000 איש בשנה — מחלה נדירה שקל לפספס</p></div>
    <div class="stat"><div class="num s">0</div><p>בדיקות מעבדה או הדמיה שמאשרות את האבחנה — היא קלינית בלבד</p></div>
  </div>
</div>
<p class="foot-note">מבוסס על ספרות הכאב המקובלת (IASP, McGill Pain Index) — נתונים להמחשה במסגרת הרצאה אישית.</p>
...
<div class="split">
  <div class="txt">
    ...
    <p class="body">
      ...
      וערכות ״We Will Dance Again״ — שאני מעניקה לאנשים שזקוקים לרגע של אור.
    </p>
    <p class="body accent-line">
      הנתינה היא משכך הכאבים היחיד שאין לו תופעות לוואי —
      וכל חיוך שקיבלתי בחזרה החזיק אותי עוד יום.
    </p>
  </div>
  <div class="pane">
    <div class="wall" style="grid-template-columns:repeat(3,1fr)">
      {''.join(fig(P(i)) for i in GIVE_INTRO)}
    </div>
  </div>
</div>""", chapter="הכוח")
...
# ================================================== 20-22 · GIVING WALLS
page(f"""
<div class="wall-head"><h2 class="h">מעניקים תקווה — זוג אחר זוג</h2>
<p class="sub">כל זוג נעליים מצויר ביד, כל מסירה היא מפגש, וכל מפגש — עוד סיבה לקום מחר.</p></div>
{wall([P(i) for i in GIVE_WALL1], 6)}
""", chapter="הכוח")

page(f"""
<div class="wall-head"><h2 class="h">הנתינה שמרפאת בחזרה</h2>
<p class="sub">אמנים, חברים ואנשים מכל הארץ הצטרפו למסע — והמעגל רק מתרחב.</p></div>
{wall([P(i) for i in GIVE_WALL2], 6)}
""", chapter="הכוח")

page(f"""
<div class="wall-head"><h2 class="h">והמעגל ממשיך להתרחב</h2>
<p class="sub">כל תמונה כאן היא אדם שקיבל — ואישה אחת עם CRPS שגילתה כמה כוח יש בידיים כואבות.</p></div>
