...
slides += gallery_section(
    ...
    "נעלי ״עם ישראל חי״ בעבודת יד לחטופים ששבו ולשורדי הטבח בנובה — ואירוח בבית פתוח, "
    "סביב שולחן וארוחה חמה, לשורדים, לשבים ולהורים השכולים של נרצחי השבעה באוקטובר",
    PDATA["aware"], per=12,
)
