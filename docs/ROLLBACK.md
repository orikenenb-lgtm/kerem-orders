...
### דגלי 3B (שלב 3B — כולם כבויים כברירת מחדל)

שמונת הדגלים האלה נוספו ב-PR #92. **כל אחד עצמאי** — אפשר להדליק אחד, כמה או את כולם.
כשכולם כבויים, `/catalog` ו-`/account` מתנהגים בדיוק כמו לפני 3B.
